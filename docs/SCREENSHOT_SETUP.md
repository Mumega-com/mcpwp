...
MCPWP can capture screenshots of any public URL using a Cloudflare Worker with Browser Rendering. This guide walks through deploying and configuring the screenshot service.
...
```
AI Assistant → MCPWP Plugin → Cloudflare Worker → Headless Chromium → Screenshot
