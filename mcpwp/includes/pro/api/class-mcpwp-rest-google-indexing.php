 ...
 */
class Mcpwp_REST_Google_Indexing extends Mcpwp_REST_API {

	/**
	 * Google Indexing handler.
	 *
	 * @var Mcpwp_Google_Indexing
	 */
	private $indexing;
	 ...
	 * Constructor.
	 *
	 * @param Mcpwp_Google_Indexing $indexing Google Indexing handler.
	 */
		...
		register_rest_route(
			...
			array(
				array(
					...
					'args'                => array(
						'urls'   => array(
							'description' => __( 'Array of URLs to submit for indexing.', 'mcpwp' ),
							'type'        => 'array',
							'required'    => true,
							'items'       => array( 'type' => 'string' ),
						),
						'action' => array(
							'description' => __( 'Indexing action: URL_UPDATED or URL_DELETED.', 'mcpwp' ),
							'type'        => 'string',
		...
		register_rest_route(
			...
			array(
				array(
					...
					'args'                => array(
						'url' => array(
							'description' => __( 'URL to check indexing status for.', 'mcpwp' ),
							'type'        => 'string',
							'required'    => true,
						),
					),
