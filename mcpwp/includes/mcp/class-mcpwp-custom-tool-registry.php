<?php
/**
 * Custom Tool Registry — mcpwp_register_tools hook API
 *
 * Lets third-party plugins register MCP tools without extending a PHP class.
 * Tools are collected via the `mcpwp_register_tools` WordPress filter.
 *
 ...
 *                                    or MCPWP-relative, e.g. '/my-endpoint' (gets /mcpwp/v1 prepended)
 ...
 *   input_props (array)           — tool parameters, same format as Mcpwp_MCP_Tool_Registry::define_tool()
...
/**
 * Collects and exposes tools registered via the mcpwp_register_tools filter.
 */
class Mcpwp_Custom_Tool_Registry extends Mcpwp_MCP_Tool_Registry {
	 ...
	 *
	 * @return array[] Raw registration arrays from mcpwp_register_tools filter.
	 */
