...
# ── Inject MCPWP_WPORG_BUILD constant for WP.org compliance ─────
echo "    Injecting MCPWP_WPORG_BUILD constant..."
...
replacement = "define( 'MCPWP_WPORG_BUILD', true );\n" + needle
if "define( 'MCPWP_WPORG_BUILD'" not in content:
