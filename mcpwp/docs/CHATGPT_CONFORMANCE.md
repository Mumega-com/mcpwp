...
```bash
cd mcpwp/tests
./test-chatgpt-conformance.sh https://your-site.com mcpwp_your_api_key
```

You can also pass the key through env:

```bash
DIGID_API_KEY=mcpwp_your_api_key ./test-chatgpt-conformance.sh https://your-site.com
```
