...
- The text domain remains `mcpwp` in every build.
- The public WP.org package root is `mcpwp/`.
- The Freemius package root remains `mcpwp/` unless Freemius configuration changes.
