...
final class EventStoreTest extends TestCase
{
    ...
    public function test_emit_stores_event_and_fires_specific_hook(): void
    {
        ...
        $this->assertSame('mcpwp_approval_created', $event['hook']);
        $this->assertSame('approval.created', $captured['type']);
        $this->assertSame('pending', $captured['approval_state']);

        $stored = Mcpwp_Event_Store::list_events(array( 'type' => 'approval.created' ));
    ...
    {
        $schema = Mcpwp_Event_Store::get_schema();
        ...
        $this->assertSame('mcpwp_seo_audit_completed', $schema['seo.audit_completed']['hook']);
    }
}
