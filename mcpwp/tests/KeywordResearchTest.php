...
require_once dirname(__DIR__) . '/includes/core/class-mcpwp-keyword-research.php';
...
final class KeywordResearchTest extends TestCase
{
    ...
    {
        $result = Mcpwp_Keyword_Research::expansions('coffee');
    ...
    {
        $result = Mcpwp_Keyword_Research::expansions('test');
    ...
    public function test_expansions_respects_cap(): void
    {
        ...
        $result = Mcpwp_Keyword_Research::expansions('something');
        $this->assertLessThanOrEqual(Mcpwp_Keyword_Research::MAX_EXPANSIONS, count($result));
    }

    public function test_expansions_returns_non_empty_array(): void
    {
        $result = Mcpwp_Keyword_Research::expansions('x');
    ...
    {
        $result = Mcpwp_Keyword_Research::group(
            'tomato',
    ...
    {
        $result = Mcpwp_Keyword_Research::group('organic tea', array( 'organic tea brands' ));
    ...
    {
        $result = Mcpwp_Keyword_Research::group('anything', array());
    ...
    public function test_group_question_starters_all_classified(): void
    {
        ...
        $result = Mcpwp_Keyword_Research::group('test', $inputs);
