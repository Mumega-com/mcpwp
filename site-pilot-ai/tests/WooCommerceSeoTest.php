...
final class WooCommerceSeoTest extends TestCase
{
    ...
    {
        $GLOBALS['_spai_test_posts'][21] = (object) array(
            'ID'           => 21,
            'post_type'    => 'product',
            'post_status'  => 'publish',
        ...
        Spai_Search_Performance::import_rows(
            array(
        ...
        $report = Spai_WooCommerce_SEO::get_report(array( 'limit' => 10 ));
    ...
    {
        $report = Spai_WooCommerce_SEO::get_report(array());
