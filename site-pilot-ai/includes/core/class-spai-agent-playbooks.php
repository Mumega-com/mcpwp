	...
	private static function definitions() {
		return array(
			...
			'seo_audit_triage' => array(
				...
				'risk_level'  => 'low',
				'mutates'     => false,
				'required_tools' => array( 'wp_get_site_state', 'wp_seo_audit_site', 'wp_get_seo_issues', 'wp_get_content_graph' ),
				'steps'       => array(
					'Read site state.',
					'Run a stored site SEO audit.',
					'List open issues by severity and category.',
					'Group issues by URL and business priority.',
					'Recommend the next approval-safe fix plan.',
				),
				'validation_gates' => array( 'wp_seo_audit_site', 'wp_get_seo_issues' ),
