 ...
 */
class Spai_Site_Memory {

	const OPTION_KEY = 'spai_site_memory';
	...
	/**
	 * Migrate legacy spai_site_context blob into identity namespace on first load.
	 */
	public static function maybe_migrate_site_context(): void {
		...
		$legacy = get_option( 'spai_site_context', '' );
		if ( ! empty( $legacy ) ) {
