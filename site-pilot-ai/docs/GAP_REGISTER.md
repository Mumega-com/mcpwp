...
8. #311 WooCommerce SEO intelligence. Status: first read-only product SEO report added `wp_get_woocommerce_seo_report` and REST `GET /site-pilot-ai/v1/seo/woocommerce`; product mutation adapters and category drill-downs remain open.
